...
export class BookEventService {
  ...
  private baseUrl = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/user/bookTheme';
  private baseUrl2 = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/user/editTheme';
  private baseUrl3 = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/user/getBookedTheme';
  private baseUrl4 = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/user/deleteTheme';
  private baseUrl5 = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/user/editReview';
