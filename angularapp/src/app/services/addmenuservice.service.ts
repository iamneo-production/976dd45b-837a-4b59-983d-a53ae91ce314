...
export class AddmenuserviceService {
  ...
  private baseUrl = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/admin/addMenu';
  private baseUrl2 = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/admin/editMenu';
  private baseUrl3 = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/admin/menu';
  private baseUrl4 = 'https://8080-beddbfbbfbabaccccfeafbbadefeafafebddcc.project.examly.io/admin/deleteMenu';
